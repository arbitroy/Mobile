...
public class DashboardActivity_RecentAttemptsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mobile.Activities.DashboardActivity+RecentAttemptsAdapter, Mobile", DashboardActivity_RecentAttemptsAdapter.class, __md_methods);
	}


	public DashboardActivity_RecentAttemptsAdapter ()
	{
		super ();
		if (getClass () == DashboardActivity_RecentAttemptsAdapter.class) {
			mono.android.TypeManager.Activate ("Mobile.Activities.DashboardActivity+RecentAttemptsAdapter, Mobile", "", this, new java.lang.Object[] {  });
		}
	}
